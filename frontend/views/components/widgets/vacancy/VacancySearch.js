    ...
    return `<div class="row block-search">
                <div class="row py-5">
                    ...
                    <div class="input-group">
                        ...
                        <div class="col-md-4">
                            <input type="search" list="blow" class="form-select form-select-lg input-search-city custom-select" id="searchCity" placeholder="Начните вводить город" />
                            <datalist id="blow">
...
function generationCitiesList(cities) {
    ...
    for(const {_source: city} of cities) {
        content += `<option value="${city.ru}" onclick="searchCity()"></option>`;
    }
    return content;
}